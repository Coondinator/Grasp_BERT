...
def basic_train():
    ...
    train_set, valid_set, test_set = torch.utils.data.random_split(dataset, [train_dataset_size, valid_dataset_size,
                                                                             test_dataset_size])
    ...
    sched = CosineLRScheduler(optim, t_initial=300, t_mul=1, lr_min=1e-6, decay_rate=0.1, warmup_lr_init=1e-6,
